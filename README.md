...
`kbridge` is part of Kannika's [open source and source-available Kafka tools]
...
Production use is permitted for non-commercial purposes or entities with less than $1M USD in annual gross revenue.
Other commercial use requires a license from Cymo NV.
